...
################################### Labels ###########################################
        ...
        self.speaker_action.grid(label_grid_params, row = 8, column = 0, sticky = 'W')
        ...
        self.speaker_thots.grid(label_grid_params, row = 4, column = 0, sticky = 'W')
        
        # baby label
        self.baby_label = tk.Label(self.labels_frame, text = 'Baby:').grid(label_grid_params, row = 3, column = 2, sticky = 'W')
        ...
        self.baby_action.grid(label_grid_params, row = 8, column = 2, sticky = 'W')
        ...
        self.baby_emotion.grid(label_grid_params, row = 5, column = 2, sticky = 'W')
        ...
        self.baby_ps_state.grid(label_grid_params, row = 6, column = 2, sticky = 'W')
        ...
        self.baby_wantsneeds.grid(label_grid_params, row = 7, column = 2, sticky = 'W')
        ...
        self.baby_thots.grid(label_grid_params, row = 4, column = 2, sticky = 'W')
        
        # external world label
        self.external_world_label = tk.Label(self.labels_frame, text = 'External World:').grid(label_grid_params, row = 3, column = 5, sticky = 'W')
        # other's label
        self.external_world_others_label = tk.Label(self.labels_frame, text = "Other's...").grid(label_grid_params, row = 4, column = 6, sticky = 'W')
        ...
        self.external_world_action.grid(label_grid_params, row = 9, column = 6, sticky = 'W')
        ...
        self.external_world_emotion.grid(label_grid_params, row = 6, column = 6, sticky = 'W')
        ...
        self.external_world_ps_state.grid(label_grid_params, row = 7, column = 6, sticky = 'W')
        ...
        self.external_world_wantsneeds.grid(label_grid_params, row = 8, column = 6, sticky = 'W')
        ...
        self.external_world_thots.grid(label_grid_params, row = 5, column = 6, sticky = 'W')
        ...
        self.obj_labelling.grid(label_grid_params, row = 4, column = 5, sticky = 'W')
        ...
        self.obj_description.grid(label_grid_params, row = 5, column = 5, sticky = 'W')
        self.events = tk.Radiobutton(self.labels_frame, text = "Events", variable = self.labels['descriptive'], value = 'Events', state = 'disabled')
        self.events.grid(label_grid_params, row = 6, column = 5, sticky = 'W')
        
        # joint speaker + baby label
        self.speaker_baby_label = tk.Label(self.labels_frame, text = 'Speaker + Baby:').grid(label_grid_params, row = 3, column = 1, sticky = 'W')
        
        #speaker + baby radiobuttons
        self.speaker_baby_action = tk.Radiobutton(self.labels_frame, text = "Action", variable = self.labels['descriptive'], value = "Speaker+Baby Action", state = 'disabled')
        self.speaker_baby_action.grid(label_grid_params, row = 8, column = 1, sticky = 'W')
        self.speaker_baby_emotion = tk.Radiobutton(self.labels_frame, text = "Emotion", variable = self.labels['descriptive'], value = "Speaker+Baby Emotion", state = 'disabled')
        self.speaker_baby_emotion.grid(label_grid_params, row = 5, column = 1, sticky = 'W')
        self.speaker_baby_ps_state = tk.Radiobutton(self.labels_frame, text = "Physical State", variable = self.labels['descriptive'], value = "Speaker+Baby Physical State", state = 'disabled')
        self.speaker_baby_ps_state.grid(label_grid_params, row = 6, column = 1, sticky = 'W')
        self.speaker_baby_wantsneeds = tk.Radiobutton(self.labels_frame, text = "Want / Need", variable = self.labels['descriptive'], value = "Speaker+Baby Want / Need", state = 'disabled')
        self.speaker_baby_wantsneeds.grid(label_grid_params, row = 7, column = 1, sticky = 'W')
        self.speaker_baby_thots = tk.Radiobutton(self.labels_frame, text = "Thoughts", variable = self.labels['descriptive'], value = "Speaker+Baby Thoughts", state = 'disabled')
        self.speaker_baby_thots.grid(label_grid_params, row = 4, column = 1, sticky = 'W')
        
        # joint speaker + external world label
        self.speaker_exw_label = tk.Label(self.labels_frame, text = 'Speaker + External World:').grid(label_grid_params, row = 3, column = 4, sticky = 'W')
        
        #speaker + external world radiobuttons
        self.speaker_ex_action = tk.Radiobutton(self.labels_frame, text = "Action", variable = self.labels['descriptive'], value = "Speaker+External World Action", state = 'disabled')
        self.speaker_ex_action.grid(label_grid_params, row = 8, column = 4, sticky = 'W')
        self.speaker_ex_emotion = tk.Radiobutton(self.labels_frame, text = "Emotion", variable = self.labels['descriptive'], value = "Speaker+External World Emotion", state = 'disabled')
        self.speaker_ex_emotion.grid(label_grid_params, row = 5, column = 4, sticky = 'W')
        self.speaker_ex_ps_state = tk.Radiobutton(self.labels_frame, text = "Physical State", variable = self.labels['descriptive'], value = "Speaker+External World Physical State", state = 'disabled')
        self.speaker_ex_ps_state.grid(label_grid_params, row = 6, column = 4, sticky = 'W')
        self.speaker_ex_wantsneeds = tk.Radiobutton(self.labels_frame, text = "Want / Need", variable = self.labels['descriptive'], value = "Speaker+External World Want / Need", state = 'disabled')
        self.speaker_ex_wantsneeds.grid(label_grid_params, row = 7, column = 4, sticky = 'W')
        self.speaker_ex_thots = tk.Radiobutton(self.labels_frame, text = "Thoughts", variable = self.labels['descriptive'], value = "Speaker+External World Thoughts", state = 'disabled')
        self.speaker_ex_thots.grid(label_grid_params, row = 4, column = 4, sticky = 'W')
        
        # joint baby + external world label
        self.speaker_exw_label = tk.Label(self.labels_frame, text = 'Baby + External World:').grid(label_grid_params, row = 3, column = 3, sticky = 'W')
        
        #baby + external world radiobuttons
        self.baby_ex_action = tk.Radiobutton(self.labels_frame, text = "Action", variable = self.labels['descriptive'], value = "Baby+External World Action", state = 'disabled')
        self.baby_ex_action.grid(label_grid_params, row = 8, column = 3, sticky = 'W')
        self.baby_ex_emotion = tk.Radiobutton(self.labels_frame, text = "Emotion", variable = self.labels['descriptive'], value = "Baby+External World Emotion", state = 'disabled')
        self.baby_ex_emotion.grid(label_grid_params, row = 5, column = 3, sticky = 'W')
        self.baby_ex_ps_state = tk.Radiobutton(self.labels_frame, text = "Physical State", variable = self.labels['descriptive'], value = "Baby+External World Physical State", state = 'disabled')
        self.baby_ex_ps_state.grid(label_grid_params, row = 6, column = 3, sticky = 'W')
        self.baby_ex_wantsneeds = tk.Radiobutton(self.labels_frame, text = "Want / Need", variable = self.labels['descriptive'], value = "Baby+External World Want / Need", state = 'disabled')
        self.baby_ex_wantsneeds.grid(label_grid_params, row = 7, column = 3, sticky = 'W')
        self.baby_ex_thots = tk.Radiobutton(self.labels_frame, text = "Thoughts", variable = self.labels['descriptive'], value = "Baby+External World Thoughts", state = 'disabled')
        self.baby_ex_thots.grid(label_grid_params, row = 4, column = 3, sticky = 'W')
        ...
        #Unclear speech button
        self.unclear = tk.Radiobutton(self.labels_frame, text = 'Unclear Speech', variable = self.labels['descriptive'], value = 'Unclear Speech', state = 'disabled')
        self.unclear.grid(label_grid_params, row = 10, column = 1, sticky = 'W')
        ...
        self.entries_handles = filter(lambda x: isinstance(x, tk.Radiobutton), self.labels_frame.children.itervalues())

        # Comments box
        self.comments_label = tk.Label(self.labels_frame, text = 'Comments:').grid(row = 11, column = 0, padx = 5, sticky = 'W')
        self.comments = tk.Text(self.labels_frame, height = 10, width = 50, state = 'disabled', relief = tk.FLAT)
        self.comments.grid(row = 12, column = 0, rowspan = 10, columnspan = 50, padx = 5, pady = 0, sticky = 'W')
    ...
    def check_target_child(self, *args):
        if self.labels['target_child'].get() == 0:
            ...
            self.speaker_baby_action.configure(state = 'disabled')
            self.speaker_baby_emotion.configure(state = 'disabled')
            self.speaker_baby_ps_state.configure(state = 'disabled')
            self.speaker_baby_wantsneeds.configure(state = 'disabled')
            self.speaker_baby_thots.configure(state = 'disabled')
            self.speaker_action.configure(state = 'disabled')
            self.speaker_ex_action.configure(state = 'disabled')
            self.speaker_ex_emotion.configure(state = 'disabled')
            self.speaker_ex_ps_state.configure(state = 'disabled')
            self.speaker_ex_wantsneeds.configure(state = 'disabled')
            self.speaker_ex_thots.configure(state = 'disabled')
            self.baby_ex_action.configure(state = 'disabled')
            self.baby_ex_emotion.configure(state = 'disabled')
            self.baby_ex_ps_state.configure(state = 'disabled')
            self.baby_ex_wantsneeds.configure(state = 'disabled')
            self.baby_ex_thots.configure(state = 'disabled')
            self.unclear.configure(state = 'disabled')
            ...
            self.speaker_baby_action.configure(state = 'normal')
            self.speaker_baby_emotion.configure(state = 'normal')
            self.speaker_baby_ps_state.configure(state = 'normal')
            self.speaker_baby_wantsneeds.configure(state = 'normal')
            self.speaker_baby_thots.configure(state = 'normal')
            self.speaker_action.configure(state = 'normal')
            self.speaker_ex_action.configure(state = 'normal')
            self.speaker_ex_emotion.configure(state = 'normal')
            self.speaker_ex_ps_state.configure(state = 'normal')
            self.speaker_ex_wantsneeds.configure(state = 'normal')
            self.speaker_ex_thots.configure(state = 'normal')
            self.baby_ex_action.configure(state = 'normal')
            self.baby_ex_emotion.configure(state = 'normal')
            self.baby_ex_ps_state.configure(state = 'normal')
            self.baby_ex_wantsneeds.configure(state = 'normal')
            self.baby_ex_thots.configure(state = 'normal')
            self.unclear.configure(state = 'normal')
    ...
    def whole_block_junk_selected(self):
        if self.junk.get() == 1:
            ...
            self.entry_initial_state()
			self.junk_checkbutton.congfigure(state = 'normal')
    ...
    def junk_selected(self):
        if self.junk.get() == 1:
            self.entry_initial_state()
            self.sensitive_checkbutton.configure(state = 'disabled')
          #  self.labels['sensitive'] = 0
            self.other_langue_checkbutton.configure(state = 'disabled')
          #  self.labels['other_langue']=0
            self.ads.configure(state = 'disabled')
          #  self.labels['ads']=0
            self.cds.configure(state = 'disabled')
          #  self.labels['cds']=0
    ...
    def load_subjects(self):
        ...
        if coder == '--> Coder\'s name <--':
            ...
            if self.data_is_saved == False: #Check if the data is saved. If it is not, ask if they really actually do want to load the data, since this will cause all unsaved data to be LOST FOREVER!!!
                answer = askyesno('Load data', 'Loading the data now will wipe all your unsaved labels. Re-load the data anyways?')
                if answer == 1:
